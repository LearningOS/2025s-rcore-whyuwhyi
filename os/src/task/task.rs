...
impl TaskControlBlock {
    ...
    pub fn mmap_area(&self, start_va: VirtAddr, end_va: VirtAddr, perm: MapPermission) -> bool {
        let mut inner = self.inner.exclusive_access();
        inner.memory_set.mmap_area(start_va, end_va, perm)
    }

    /// unmap a area in current task's memory set
    pub fn munmap_area(&self, start_va: VirtAddr, end_va: VirtAddr) -> bool {
        let mut inner = self.inner.exclusive_access();
        inner.memory_set.munmap_area(start_va, end_va)
    }
